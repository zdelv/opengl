...
class ShaderProg {
    ...
    public:
        ...
        ShaderProg(const GLchar* vertexPath, const GLchar* fragPath);

};

ShaderProg::ShaderProg(const GLchar* vertexPath, const GLchar* fragPath)
{
    ...
    if (!success)
    {
        ...
        std::cout << "Error::ShaderProg::Vertex: Compilation Failure\n" << infoLog << std::endl;
    }
    ...
    if (!success)
    {
        ...
        std::cout << "Error::ShaderProg::Fragment: Compilation Failure\n" << infoLog << std::endl;
    }
    ...
    if (!success)
    {
        ...
        std::cout << "Error::ShaderProg::Program: Linking Failure\n" << infoLog << std::endl;
    }
...
void ShaderProg::setFloat(const std::string &name, float val1, float val2, float val3, float val4)
{
